		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Emp Details",
									"targetURL": "#comdeloittelistreport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdeloittelistreport-display": {
								"semanticObject": "comdeloittelistreport",
								"action": "display",
								"description": "Emp Details App",
								"title": "Emp Details",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.deloitte.listreport",
									"url": sap.ui.require.toUrl("com/deloitte/listreport")
								}
							}
						}
					}
